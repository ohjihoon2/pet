...
<link rel="stylesheet" type="text/css"href="http://localhost:9090/pet/css/admin/admin_notice_write.css">
...
$(document).ready(function(){
	...
	$(function() {
	   	nhn.husky.EZCreator.createInIFrame({
	               oAppRef: oEditors,
	               elPlaceHolder: document.getElementById('not_content'),
				...
				fOnAppLoad : function(){
					...
					oEditors.getById["not_content"].exec("PASTE_HTML", [""]);	
				}, 
	...
	$("#btnNoticeWrite").click(function(){
	    ...
	    var contents = document.getElementById("not_content").value;
		...
		if($("#not_title").val() == ""){
			...
			alert("내용을 입력해주세요.");
			oEditors.getById["not_content"].exec("FOCUS"); //포커싱
			return false;
		}else {
...
<body>
	...
	<div id="content">
		<div id="vet">
			...
			<form action="admin_notice_update_proc.do" method="post" name="vetFrom" enctype="multipart/form-data">
			<table>
					
					<tr>
						<td>메인타이틀</td>
						<td><input type="text" name="not_title" id="not_title" class="maintt" value="${vo.not_title}"></td>
					</tr>
					<tr>
						...
						<td>
							 <div id="con">
								<div id="box_01_02"  style="width: 687px;display: inline-block;">
									<div class="content"> 
										 <textarea rows="10" cols="30" id="not_content" name="not_content" style="width: 685px; height: 412px;">${vo.not_content}</textarea> 
					...
					<a href="http://localhost:9090/pet/admin_notice_content.do?not_no=${vo.not_no}"><button type="button">이전으로</button></a>
