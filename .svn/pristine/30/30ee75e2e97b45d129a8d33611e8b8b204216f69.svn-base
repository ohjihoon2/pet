...
<link rel="stylesheet" type="text/css"href="http://localhost:9090/pet/css/vet6.css">
	...
	$(document).ready(function(){
		...
		var pager = jQuery('#ampaginationsm').pagination({
		 ...
		 jQuery('#ampaginationsm').on('am.pagination.change',function(e){
	           ...
	           $(location).attr('href', "http://localhost:9090/pet/vet6.do?rpage="+e.page);         
	    }); 
	});
</script>
</head>
				...
				<div class="goods_tab_cont">
					<div class="pick_list">
						<ul>
							...
							<li class="con">
								<div class="pick_cont">
									<a href="http://localhost:9090/pet/vet6_detail.do?tip_id=${vo.tip_id}&page=${rpage}">
