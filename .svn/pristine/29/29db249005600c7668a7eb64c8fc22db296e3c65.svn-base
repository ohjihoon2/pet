...
<body>
	<form id="insertForm" action="answer_proc.do" method="post" class="insertForm">
		<section class="main">
	
			<div class="box_01" style="width: 690px; margin: 0 auto;">
				<input placeholder="제목을 적어주세요." class="form-control" maxlength="61" type="text" name="wonder_answer_title" id="wonder_answer_title" value="">
			</div>
			...
			<div class="box_01" style="width: 690px; margin: 0 auto; border-bottom: 0px;">
				...
				<div id="box_01_02">
					<div class="wonder_answer_content">
						<textarea rows="10" cols="30" id="wonder_answer_content" name="wonder_answer_content" style="width: 685px; height: 412px;"></textarea>
					</div>
				</div>
			</div>
			
			<input type="hidden" id="wonder_no" name="wonder_no" value="${wonder_no }">
			<input type="hidden" id="wonder_answer_writer" name="wonder_answer_writer" value="${sid }">
			<div class="btn">
