...
<body>
	...
	<div id="content">
		<div id = "photo_mgm">
			...
			<form action="admin_cat_good_insert_proccess.do" name="good_insForm" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>고양이 아이템</td>
					<td>
					<select name="item_cate_no">
						<option value="1004">사료</option>
						<option value="1005">간식</option>
						<option value="1006">모래</option>
					</select>
					</td>
				</tr>
