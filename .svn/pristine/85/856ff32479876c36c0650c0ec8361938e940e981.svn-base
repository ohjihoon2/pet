...
<body>
	...
	<div id="content">
		<div id="vet">
			<h1 class="title">고양이 상품 삭제</h1>
			<div>
				<span class="conform">정말로 삭제하시겠습니까? </span>
			</div>
			<div class="vet_btn">
				<a href="http://localhost:9090/pet/admin_cat_delete_proccess.do?item_no=${item_no}"><button type="button">삭제완료</button></a>
				<a href="http://localhost:9090/pet/admin_cat_item.do"><button type="button">목록으로</button></a>
			</div>		
		</div>
	</div>
