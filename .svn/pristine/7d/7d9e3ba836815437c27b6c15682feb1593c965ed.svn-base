	...
	<script> 
		$(document).ready(function(){
			$(".btn_back").click(function(){
				location.href="itemDetail.do?iid="+${vo.ITEM_NO};
			});		
			
			$(".btn_up").click(function(){
				location.href="item_review_update.do?ITEM_BOARD_NO="+${vo.ITEM_BOARD_NO};
			});	
			
			$(".btn_del").click(function(){
				location.href="item_review_delete.do?ITEM_BOARD_NO="+${vo.ITEM_BOARD_NO}+"&ITEM_NO="+${vo.ITEM_NO};
			});	
	...
	<table class="item_write">
		...
		<tr class="tr4">
			<td colspan="6">
				...
				<button class="btn_up" type="button">수정하기</button>
				<button class="btn_del" type="button">삭제하기</button>
			</td>
		</tr>
	</table>
