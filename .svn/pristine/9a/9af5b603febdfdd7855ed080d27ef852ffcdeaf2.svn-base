...
$(document).ready(function() {
	...
	$(function() {
		/** 회원가입 폼 유효성 체크 **/
		$("#contestupdatebtn").click(function() {	
			 if ($("#profile_pt").val() == 0) {
					alert("사진을 등록해 주세요.");
					$("#profile_pt").focus();
				}else if ($("#contest_title").val() == 0) {
					...
					contest_content_update_form.submit();
				}
			});//form check
		});
