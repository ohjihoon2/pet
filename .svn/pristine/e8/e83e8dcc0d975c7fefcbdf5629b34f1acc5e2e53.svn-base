...
<body>
	...
	<div id="content">
		<div id="vet">
			<h1 class="title">강아지 전문가팁 삭제</h1>
			<div>
				<span class="conform">정말로 삭제하시겠습니까? </span>
			</div>
			<div class="vet_btn">
				<a href="http://localhost:9090/pet/admin_dog_vet_delete_proc.do?tip_id=${tip_id}"><button type="button">삭제완료</button></a>
				<a href="http://localhost:9090/pet/admin_dog_vet.do"><button type="button">목록으로</button></a>
				<a href="http://localhost:9090/pet/admin_dog_vet_content.do?tip_id=${tip_id}"><button type="button">이전페이지</button></a>
			</div>		
		</div>
	</div>
