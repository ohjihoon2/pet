...
<link rel="stylesheet" type="text/css"href="http://localhost:9090/pet/css/admin/admin_notice.css">
...
$(document).ready(function(){
	...
	var pager = jQuery('#ampaginationsm').pagination({
	 ...
	 jQuery('#ampaginationsm').on('am.pagination.change',function(e){
           ...
           $(location).attr('href', "http://localhost:9090/pet/admin_notice.do?rpage="+e.page);         
    }); 
});
...
<body>
	...
	<div id="content">
		<div id="vet">
			...
			<div class="vet_btn">
				<a href="http://localhost:9090/pet/admin_notice_write.do">
			...
			<table>
					...
					<tr>
						<td>${vo.rno}</td>
						<td class="table_title"><a href="http://localhost:9090/pet/admin_notice_content.do?not_no=${vo.not_no}">${vo.not_title}</a></td>
						<td>${vo.not_date}</td>
						<td>${vo.not_hits}</td>
					</tr>
					</c:forEach>
