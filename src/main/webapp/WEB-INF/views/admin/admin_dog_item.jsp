...
<body>
	...
	<div id="content">
		<div id = "photo_mgm">
			...
			<table>
				<tr>
					<td colspan="9"><a href="admin_dog_good_insert.do"><button type="button">상품등록</button></a></td>
				</tr>
				...
				<c:forEach var="vo" items="${list }">	
					<tr>
						...
						<td><a href="admin_dog_content.do?item_no=${vo.item_no}&rpage=${rpage}">${vo.item_name}</a></td>
						<td>${vo.item_price}</td>
						<td>${vo.item_cate_cate1}</td>
						<td>${vo.item_cate_brand1}</td> 
						<td>${vo.item_cate_feature1}</td> 
						<td>${vo.item_cate_material1}</td> 
						<td><a href="admin_dog_delete.do?item_no=${vo.item_no}">삭제</a></td>
					</tr>
				</c:forEach>
				<tr>
