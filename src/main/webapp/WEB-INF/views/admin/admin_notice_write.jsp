...
<body>
	...
	<div id="content">
		<div id="vet">
			...
			<form action="admin_notice_write_proc.do" method="post" name="vetFrom" enctype="multipart/form-data">
			<table>
					
					<tr>
						<td>메인타이틀</td>
						<td><input type="text" name="not_title" id="not_title" class="maintt"></td>
					</tr>
					<tr>
						...
						<td>
							 <div id="con">
								<div id="box_01_02"  style="width: 687px;display: inline-block;">
									<div class="content"> 
										 <textarea rows="10" cols="30" id="not_content" name="not_content" style="width: 685px; height: 412px;"></textarea> 
