...
<link rel="stylesheet" type="text/css"href="http://localhost:9090/pet/css/vet2_result.css">
...
<!-- 강아지 - 반려동물 사료 추천 "결과" -->
				...
				<div class="dog_vet2_cont">
					<div class="feed_all">
						<ul>
						<h1>칼로리 계산 결과</h1>
						<p>당신의 반려견에게는 하루 ${kcal*acti*weight}${item_cate_material1}Kcal의 에너지가 필요합니다. </p>
