...
<link rel="stylesheet" type="text/css"href="http://localhost:9090/pet/css/vet3_detail.css">
							...
							<div class="a" > 
							    <div class="b">
							        <li class="number">NO.${vo.tip_id }</li>
							         <h2 >${vo.tip_maintitle }</h2>
							             <p>[${vo.tip_maintitle } Tip!!]</p>
							    </div>
							             <p class="sub">${vo.tip_content }</p> 	
							                       	
							              	
							</div>
							
							
							<li class="recom_tit">강아지 추천 꿀템</li>
								<p id="dhgsl"></p>
							     <div class="demo">
						            <div class="item" >
