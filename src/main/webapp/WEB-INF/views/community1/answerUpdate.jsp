	...
	if(result == 0){
		...
		$(function() {
           	nhn.husky.EZCreator.createInIFrame({
                       oAppRef: oEditors,
                       elPlaceHolder: document.getElementById('wonder_answer_content'),
					...
					fOnAppLoad : function(){
						...
						oEditors.getById["wonder_answer_content"].exec("PASTE_HTML", [""]);	
					}, 
...
//					alert(oEditors.getById["content"].getcontent+"js방법");
				    ...
				    var contents = document.getElementById("wonder_answer_content").value;
				    console.log(contents);
//				    alert(contents);
					
					if ($("#wonder_answer_title").val() == "") {
						alert("제목을 입력해주세요");
						$("#wonder_answer_title").focus();
						return false;
					} else if (contents == ""  || contents == null || contents == '&nbsp;' || contents == '<p>&nbsp;</p>' || contents == "<br>") {
						alert("내용을 입력해주세요");
						oEditors.getById["wonder_answer_content"].exec("FOCUS"); //포커싱
						return false;						
					} else {
						// 이게 있어야 데이터가 1번만 들어가는듯함 
						oEditors.getById["wonder_answer_content"].exec("UPDATE_CONTENTS_FIELD", []);
...
<body>
	<form id="updateForm" action="answerUpdate_proc.do" method="post" class="updateForm">
		<section class="main">
	
			<div class="box_01" style="width: 690px; margin: 0 auto;">
				<input placeholder="제목을 적어주세요." class="form-control" maxlength="61" type="text" name="wonder_answer_title" id="wonder_answer_title" value="${avo.wonder_answer_title }">
			</div>
	
			<div class="box_01" style="width: 690px; margin: 0 auto; border-bottom: 0px;">
				<!-- <h1>질문 내용</h1> -->
				<div id="box_01_02">
					<div class="wonder_answer_content">
						<textarea rows="10" cols="30" id="wonder_answer_content" name="wonder_answer_content" style="width: 685px; height: 412px;">
			...
			<input type="hidden" id="wonder_answer_no" name="wonder_answer_no" value="${wonder_answer_no }">
			<div class="btn">
