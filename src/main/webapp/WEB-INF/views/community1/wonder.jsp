...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".wonderWriteBtn").click(function(){
				if(sid ==""){
					alert("로그인시 이용가능합니다. 로그인 페이지로 이동합니다.");
					$(location).attr('href', "http://localhost:9090/pet/login.do");
				}else{
					$(location).attr('href', "http://localhost:9090/pet/wonderNew.do");
				...
				<form action="#" method="get">
					<table class="wonderTable">
						...
						<div class="btndiv">
							...
							<button type="button" class="wonderWriteBtn">쓰기</button>
						</div>
				</form>												
