...
<body>
	<div>
		<div id="login">
			<form action="login_Id_proc.do" method="post" class="login" name="loginIdform">
				<span>아이디 찾기</span> 
				<input type="text" name="mem_name" id="id" placeholder="이름을 입력해 주세요."> 
				...
				<div id="id_find">
					<a href="login_Pw.do"><span style="color: #777;">비밀번호 찾기</span></a>
				</div>
				<button type="button" id="btnLoginId" >다음</button>
			</form>
